...
SYSTEM_PROMPT = (
    ...
    "【发布标准】\n"
    "1. 只保留与人工智能行业直接相关的新闻。\n"
    "2. 优先选择（按优先级）：新模型/新版本发布、模型泄露（权重/内部模型）、benchmark 跑分对比（得分/排名/超越谁）、AI 数学突破（定理证明/奥数）、AI 金融应用（量化/交易/对冲基金）、技术研究突破。\n"
    "3. 一般：巨头动态、产品更新、芯片算力、行业趋势。\n"
    "4. 降权或剔除：公司战略/IPO/人事变动/纯商业评论（除非有硬数据）、广告营销、谣言、惊悚标题党、与 AI 无关。\n"
    ...
    "3. 若是跑分/对比类：必须给出具体分数、排名、与竞品的差距（如『MMLU 92.1%，超越 GPT-4o 3 个百分点』）。\n"
